 ...
 * @param  {Function} execution The function that will be executed when any of the dependencies have
 *                              changed. The function should perform any functions required and has 
 *                              the signature:
 *                              function(pipeline, dependencyValues) {}
 */
Pipeline.prototype.stage = function(dependencyIds, execution)
{
 ...
 * first DependencyTranslator added that is registered to handle it. If no DependencyTranslator is 
 * registered the default VariableDependencyTranslator will be used.
 * 
